...
paramsRequests = {
    ApiMethod.GetTowns.value: {'params': {'token': 'token'}, 'min_params': 1, 'count': 1, 'type': 1},
    ...
    ApiMethod.GetListComments.value: {'params': {'token': 'token', 'type': {'profile': 'profile',
                                                                            'contract': 'contract'},
                                      'id': 'id'}, 'min_params': 3, 'count': 3, 'type': 1},
    ...
    ApiMethod.AddWitcherInContract.value: {'params': {'token': 'token', 'id': 'id'},
                                           'min_params': 2, 'count': 2, 'type': 0},

    ApiMethod.GetAdvert.value: {'params': {'token': 'token', 'id': 'id'}, 'min_params': 2, 'count': 2, 'type': 1},

    ApiMethod.GetProfile.value: {'params': {'token': 'token', 'id': 'id'}, 'min_params': 2, 'count': 2, 'type': 1},

    ApiMethod.DeleteAdvert.value: {'params': {'token': 'token', 'id': 'id'}, 'min_params': 2, 'count': 2, 'type': 1},
